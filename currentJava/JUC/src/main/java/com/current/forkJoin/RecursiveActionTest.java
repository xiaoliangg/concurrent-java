...
class SortTask extends RecursiveAction {
    ...
    protected void compute() {
        if (hi - lo < THRESHOLD)
            ...
            new SortTask(array, lo, pivot - 1).exec();
            new SortTask(array,pivot + 1, hi).exec();
...
public class RecursiveActionTest {
    private static final int NARRAY = 8; //For demo only
    ...
    public void testSort() throws Exception {
        ...
        Assert.assertTrue(checkSorted(array));
    }
